...
using Bmg.Desafio.Core.Api.Factory;
using Bmg.Desafio.Core.Application.DTO.Aggregates.CommonAgg.Models;
using Bmg.Desafio.Core.Application.DTO.Http.Models.CommonAgg.Commands.Responses;
using Bmg.Desafio.CrossCuting.Infra.Utils.Extensions;
using System.Net.Http.Json;

namespace Bmg.Desafio.WebApp.Controllers
{
