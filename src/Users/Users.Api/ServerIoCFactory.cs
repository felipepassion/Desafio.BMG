    ...
    public static partial class IoCFactory {
        ...
        private static void ConfigureAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddDataProtection()
                .PersistKeysToDbContext<UsersAggContext>()
        ...
        public static void OnAppInitialized(this WebApplication app)
        {
            using (var scope = app.Services.CreateScope())
            {
                ...
                logProvider.Write(new Bmg.Desafio.CrossCutting.Infra.Log.Entries.LogEntry("------> APP | Users.Api | STARTED <------", action: "OnAppInitialized"));
            }
        }
    }
}
