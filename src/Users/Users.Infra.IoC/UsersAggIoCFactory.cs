...
using Bmg.Desafio.Users.Application.Aggregates.UsersAgg.AppServices;
...
namespace Bmg.Desafio.Users.Infra.IoC {
	using Core.Infra.IoC.Extensions;
    using Core.Api.Middlewares;
	using Infra.Data.Context;
	using Domain.Aggregates.UsersAgg.Commands.Handlers;
